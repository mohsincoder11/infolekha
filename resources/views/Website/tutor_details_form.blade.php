                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div >
                                            ...
                                            <form  method="post" action="{{url('tutor_detail_create',$data->id)}}"  class="form-profile" en id="form2">
                                              @csrf
                                              <div class="row">
                        ...
                        >
                                                  ...
                                                  <div class="col-lg-6">
                                                    <div class="form-group">
                                                      ...
                                                      <input type="text" readonly class="form-control" placeholder="Mobile No" value="{{$data->mob}}" name="mob"
                        >
                                                    </div>
                                                  </div>
                                                  <div class="col-lg-6">
                                                    <div class="form-group">
                                                      ...
                                                      <input type="text" readonly class="form-control" placeholder="Email ID"  value="{{$data->email}}" name="email"
                        >
                                                    </div>
                                                  </div>
