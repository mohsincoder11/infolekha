    ...
    <div class="dashboard-content">
        ...
        <div class="container dasboard-container">
            ...
            <div class="dasboard-widget-box fl-wrap">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <form method="post" action="{{ route('school_profile.update-blog') }}" id="blog_form"
        ...
        <textarea placeholder="Content1" name="content1" id="content1" rows="8" style="height: 150px;">{!! $edit_data->content1 !!}</textarea>
                                ...
                                <div class="col-md-12" style="margin-top:10px;">
                                    <textarea placeholder="Content2" name="content2" id="content2" rows="8" style="height: 150px;">{!! $edit_data->content2 !!}</textarea>

                                    <span class="editor_error"></span>
                                </div>

                                <div class="col-md-12" style="margin-top:10px;">
                                    <textarea placeholder="Content3" name="content3" id="content3" rows="8" style="height: 150px;">{!! $edit_data->content3 !!}</textarea>

                                    <span class="editor_error"></span>
                                </div>

                                <div class="col-md-12" style="margin-top:10px;">
                                    <textarea placeholder="Content4" name="content4" id="content4" rows="8" style="height: 150px;">{!! $edit_data->content4 !!}</textarea>
