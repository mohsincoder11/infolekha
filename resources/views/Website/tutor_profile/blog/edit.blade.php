    ...
    <div class="dashboard-content">
        ...
        <div class="container dasboard-container">
            ...
            <div class="dasboard-widget-box fl-wrap">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <form method="post" action="{{ route('tutor_profile.update-blog') }}" id="blog_form"
                            ...
                            <div class="custom-form">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" placeholder="Subject of Blog" value="{{ $edit_data->subject }}"
                                        name="subject" />
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select data-placeholder="Status" class="chosen-select on-radius no-search-select"
                                        ...
                                        @foreach (get_blog_categories() as $cat)
                                            <option value="{{ $cat }}"
                                                @if ($cat == $edit_data->category) selected="selected" @endif>
                                                {{ $cat }}</option>
                                        @endforeach
                                        <option value="Other" @if (!in_array($edit_data->category, get_blog_categories())) selected="selected" @endif>
                                            Other</option>
                                    </select>
                                </div>
                                <div class="col-md-6 @if (!in_array($edit_data->category, get_blog_categories())) @else d-none @endif"
                                    id="other_category_div">
                                    <label style="font-size:16px;">Specify Other Category </label>
                                    <input type="text" placeholder="other category" value="{{ $edit_data->category }}"
                                ...
                                <div class="col-md-2">
                                    <a href="{{ asset('public/' . $edit_data->blog_image) }}" target="_blank"> <img
                                            height="50" width="50"
                                            src="{{ asset('public/' . $edit_data->blog_image) }}" alt=""></a>
                                </div>

                                <div class="col-md-12" style="margin-top:10px;">
            <textarea  placeholder="Content1" name="content1" id="content1" rows="8" style="height: 150px;">{!! html_entity_decode($edit_data->content1) !!}</textarea>
                                ...
                                <div class="col-md-12" style="margin-top:10px;">
                                    <textarea  placeholder="Content2" name="content2" id="content2" rows="8" style="height: 150px;">{!! html_entity_decode($edit_data->content2) !!}</textarea>
                                ...
                                <div class="col-md-12" style="margin-top:10px;">
                                    <textarea  placeholder="Content3" name="content3" id="content3" rows="8" style="height: 150px;">{!! html_entity_decode($edit_data->content3) !!}</textarea>
                                ...
                                <div class="col-md-12" style="margin-top:10px;">
                                    <textarea  placeholder="Content4" name="content4" id="content4" rows="8" style="height: 150px;">{!! html_entity_decode($edit_data->content4) !!}</textarea>
