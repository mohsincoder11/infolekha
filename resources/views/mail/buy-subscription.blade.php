...
<body>
    <div class="container">
        <div class="header">
            <h1 style="font-size: 24px;">Activation Pending</h1>
        </div>
        <div class="content">
            <p style="font-size: 18px;">Dear {{$user_info['name']}},</p>
            <p style="font-size: 18px;">We'd like to remind you that your activation is due as you have not completed the payment.</p>
          
            <p class="mb-10">Click the button below to make payment to activate your profile</p>
            <a class="btn" href="{{$url}}">Buy Subscription</a>
