				...
				<ul class="metismenu" id="menu">
					...
					<li>
						...
						<ul>
							...
							<li> <a href="{{route('admin.master.institute')}}"><i class="bx bx-right-arrow-alt"></i>Institute</a>
							</li>
	
							<li> <a href="{{route('admin.master.course')}}"><i class="bx bx-right-arrow-alt"></i>Courses</a>
							</li>
	
							<li> <a href="{{route('admin.master.faculty')}}"><i class="bx bx-right-arrow-alt"></i>Faculties</a>
							</li>
	
							
							<li> <a href="{{route('admin.master.entity')}}"><i class="bx bx-right-arrow-alt"></i>Entity</a>
							</li>
	
							<li> <a href="{{route('admin.master.class')}}"><i class="bx bx-right-arrow-alt"></i>Class</a>
							</li>
