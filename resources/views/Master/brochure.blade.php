					...
					<div class="col-md-8 mx-auto" >
						<div class="card">
							<div class="card-body">
								...
								<form class="row g-2" action="{{route('admin.master.create_brochure')}}" method="post" enctype="multipart/form-data">
									@csrf
									...
									<tr>
										...
										<td>
											{{-- <button type="button" class="btn"><div class="form-check form-switch">  <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault">  </div>	</button> --}}
											 <a href="{{route('admin.master.edit_brochure',$brochuress->id)}}">
											<button type="button" class="btn1 btn-outline-success"><i class='bx bx-edit-alt me-0'></i></button> </a>
											<a href="{{route('admin.master.destroy_brochure',$brochuress->id)}}">
