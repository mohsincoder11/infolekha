					...
					<div class="col-md-8 mx-auto" >
						<div class="card">
							<div class="card-body">
								...
								<hr>
								<form class="row g-2" method="post" action="{{route('admin.master.update_job')}}">
									@csrf
