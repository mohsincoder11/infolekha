                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Add Advertisement Package</h5>
                            </div>
                            <hr>

                            <form class="row g-2" action="{{ route('admin.master.create_advertisement') }}" method="post"
                                ...
                                @csrf
									...
									<div class="col-md-2">
										...
										<input class="form-control mb-3" type="text" placeholder="Label"
											aria-label="default input example" name="label">
									</div>
									<div class="col-md-2">
