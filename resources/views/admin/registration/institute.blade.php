                 ...
                 --}}
                    <div class="col-md-2">
                        ...
                        <select class="form-select mb-3" aria-label="Default select example" name="active">
                            <option value="" {{ request('active') == '' ? 'selected' : '' }}>Select Status</option>
                            <option value="0" {{ request('active') == '0' ? 'selected' : '' }}>Pending</option>
                            <option value="1" {{ request('active') == '1' ? 'selected' : '' }}>Active</option>
                            <option value="2" {{ request('active') == '2' ? 'selected' : '' }}>Reject</option>
                        </select>
                    </div>
                                    ...
                                    <td>
                                        <div class="tooltip-wrap2">{{ $dt->r_name }}
                                            <div class="tooltip-content2">
                                                ...
                                                <label><b>Name of
                                                        Institution:</b>{{ $dt->r_name }}</label><br>
                                                <label><b>Name of
