                        ...
                        <div class="nav-wrap">
                            <nav id="mainnav" class="mainnav float-right" style="margin-top:1em">
                                 <ul class="menu menunone">
									...
									<li style="margin-top: 5%;"> <p class="inpclass"  ><input type="text" id="current_location"  class="current_location "   name="address" required="" style="background-color: #073D5F;border-radius: 4px; height:37px; color: #fff;" >   </p>  </li>
...
@if(auth()->check())
<li style="color: black !important;">  <img src="{{asset('website_asset/images/user.png')}}" > 
					...
					@endif
                                ...
                                <ul class="menu menu1 " style="display: none; background-color: #073D5F;">
                                    ...
                                    <li class="home" id="event">
                                        <a href="{{route('event')}}" style="color: #fff; padding-top: -10% !important;"><i class="fa fa-book" aria-hidden="true"></i> Events</a>
                                    </li>
                                    ...
                                    <li><a href="#" style="color: #fff;"> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Sign Up</a>
                                        <ul class="submenu">
                                            <li><a href="{{route('school_institute_register_form')}}" style="color: #fff;">School/College/Institution</a>
                                            </li>
                                            <li><a href="{{route('student_register_form')}}" style="color: #fff;">Student/Parent</a>
                                            </li>
                                            <li><a href="{{route('tutor_register_form')}}" style="color: #fff;">Tutor/Faculty</a>
                                            </li>
                                        </ul><!-- /.submenu -->
                                    </li>
                            ...
                            <div class="menu1" style="display: none;">
                               <p class="inpclass"><input type="text" id="current_location2"  class="current_location "   name="address" required="" style="background-color: #073D5F; height:37px; border-radius: 4px; color: #fff; " >   </p> 
                            </div>
                        </div><!-- /.nav-wrap -->
                    </div><!-- /.col-lg-8 -->
                </div><!-- /.row -->
...
<div class="container">
    <div class="bottom">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                  <div class="copyright">
                    <p>© {{date('Y')}} INFOlekha Services LLP. <a href="https://themeforest.net/user/themesflat/portfolio"></a> All
                        Rights Reserved.&nbsp;
                    </p>
                </div>
            </div>
