...
class SliderlinkController extends Controller
{
    public function index(){
       ...
       public function create(Request $request){
        ...
        $brochure->save();
        return redirect(route('admin.master.slider'))->with(['success'=>'data inserted successfully.']);;
    }
     ...
     public function update(Request $request)
     {
        ...
        //  return redirect()->route('admin.master.brochure')->with(['success'=>true,'message'=>'Successfully Updated !']);
         return redirect(route('admin.master.slider'))->with(['success'=>'Successfully Updated !']);
     }
     ...
     public function destroy($id)
     {
         ...
         return redirect(route('admin.master.slider'));
     }
    }    